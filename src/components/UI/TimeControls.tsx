    ...
    return (
      <div className="flex items-center gap-1 bg-card/90 backdrop-blur-xl rounded-xl p-2 border border-border/50 shadow-lg shadow-primary/5 w-full">
        ...
        <Popover>
          ...
          <PopoverContent className="w-72 bg-card/95 backdrop-blur-xl border-border/50 shadow-xl">
            <div className="space-y-4">
              ...
              <Collapsible open={showTime} onOpenChange={setShowTime}>
                <CollapsibleTrigger asChild>
                  <Button variant="ghost" size="sm" className="w-full justify-between text-muted-foreground hover:text-foreground h-10">
              ...
              <Button onClick={handleDateChange} className="w-full bg-primary/90 hover:bg-primary h-10" size="sm">
                Go to Date
              </Button>
              
              {/* Presets in mobile date picker */}
